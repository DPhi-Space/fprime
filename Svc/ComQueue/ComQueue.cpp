...
namespace Svc {
    ...
    void ComQueue::comStatusIn_handler(const NATIVE_INT_TYPE portNum, Fw::Success& condition) {
        ...
        case WAITING:
            ...
            if (condition.e == Fw::Success::SUCCESS) {
                this->m_state = READY;
                //std::cout << "[ComQueue] State: READY  " << std::endl;
                this->processQueue();
                ...
                //std::cout << "[ComQueue] State: WAITING " << std::endl;
                this->m_state = WAITING;
            }
            break;

        case UNACKED_FULL: {
            //std::cout << "[ComQueue] State: UNACKED_FULL " << std::endl;
            // TODO 
            ...
            {
                //std::cout << "[ComQueue] Unacked Not Full " << std::endl;
                this->m_state = READY;
            }
            break;
        }
    ...
    void ComQueue::run_handler(const NATIVE_INT_TYPE portNum, U32 context) {
        ...
        if (unacked_full)
        {
            ...
            //std::cout << "[ComQueue] Unacked Full" << std::endl;
